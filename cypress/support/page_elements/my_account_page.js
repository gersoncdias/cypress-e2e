class MY_ACCOUNT_PAGE {
  constructor() {
    ...
    this.LINK_ADRESS = 'a[href="#/addresses"]'
    this.LINK_ADRESS_MOBILE = '.vtex-account__page .vtex-pageHeader__title'
    this.LINK_MY_ORDER = 'a[href="#/my-orders"]'
    this.LINK_MY_CARDS = 'a[href="#/cards"]'
    this.LINK_MY_CREDIT = 'a[href="#/meus-creditos-custom"]'
    this.LINK_AUTH = 'a[href="#/authentication"]'
    this.LINK_MY_WORK = 'a[href="#/minhas-obras"]'
