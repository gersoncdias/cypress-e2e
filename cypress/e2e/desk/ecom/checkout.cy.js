...
describe('Não Regionalizado Logado', () => {
  it('01 CH - Validate obligation of personal data fields', { tags: ['@smoke', '@critical'] }, () => {
  ...
  it('01.1 CH - Validate edit personal data', () => {
    cy.setupCartWithProductAndAddress(
      validation_data_products.product_unit,
      validation_data_reg.regionalization.order_form.mooca
    )
  ...
  it('02.1 CH - Validate edit Address', { tags: ['@smoke'] }, () => {
    cy.setupCartWithProductAndAddress(
      validation_data_products.product_unit,
      validation_data_reg.regionalization.order_form.mooca
    )
  ...
  it('03 CH - Validate payment', { tags: ['@smoke'] }, () => {
    cy.setupCartWithProductAndAddress(
      validation_data_products.product_unit,
  ...
  it('04 CH - Validor Order summary', { tags: ['@smoke'] }, () => {
    cy.setupCartWithProductAndAddress(
      validation_data_products.product_unit,
      validation_data_reg.regionalization.order_form.mooca
    )
  ...
  it('06 CH - Validate Total products', { tags: ['@smoke', '@critical'] }, () => {
    cy.setupCartWithProductAndAddress(
  ...
  it('07 CH - Validar botão "Finalizar compra"', { tags: ['@smoke', '@critical'] }, () => {
    cy.setupCartWithProductAndAddress(
      validation_data_products.product_unit,
      validation_data_reg.regionalization.order_form.mooca
    )
